...
export const logisticsService = {
  ...
  createPole: (data) => api.post('poles/', data),
  deletePole: (id) => api.delete(`poles/${id}/`),
  ...
  createSousCategory: (data) => api.post('sous-categories/', data),
  updateSousCategory: (id, data) => api.patch(`sous-categories/${id}/`, data),
  deleteSousCategory: (id) => api.delete(`sous-categories/${id}/`),
